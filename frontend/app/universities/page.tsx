          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 pb-4 border-b border-sky/15">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-soft mt-1.5 font-medium">
                Explore universities and find the one that fits you.
              </p>
            </div>

            {/* Filters Row: Type Filters + Locations + Clear */}
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              {/* Type Filters (Public / Private) */}
              ...
              {/* Reset Filters */}
              {(selectedLocation !== "All Locations" || selectedType !== null || searchQuery) && (
                <button
                  onClick={() => {
