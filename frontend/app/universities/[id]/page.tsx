  ...
  return (
    <div className="min-h-screen bg-powder text-blue-ink flex flex-col">
      ...
      <div className="w-full flex-1 px-[25px] py-6 sm:px-10 lg:px-[80px] flex flex-col">
        <BackLink href="/universities" label="Back to Universities" className="mb-6" />

        {/* ── Main Content Container ────────────────────────── */}
        <main className="w-full pb-16 flex flex-col gap-10">
          {/* 1. Hero Campus Image Banner & Title Below Like Old Version */}
          <section className="w-full">
            {/* Hero campus image banner with increased height */}
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 divide-y sm:divide-y-0 sm:divide-x divide-sky/15">
                ...
                <div className="flex flex-col items-center text-center px-2">
                  <span className="font-display text-2xl sm:text-3xl font-extrabold text-blue-ink">
                    {university.established ? `Est. ${university.established}` : "Accredited"}
                  </span>
          ...
          {/* 3. Tuition Fee & Admission Requirements Aligned Side-by-Side (Justify Content) */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full items-stretch">
                      ...
                      {university.tuitionDetails && university.tuitionDetails.length > 0 && (
                        <div className="space-y-2">
                          <h3 className="text-[11px] font-bold uppercase tracking-wider text-gray-soft mb-2">
                            Fee Breakdown by Program / Category
                          </h3>
                          <div className="space-y-2">
                ...
                {university.admissionRequirements && (
                  <div className="bg-white rounded-3xl p-6 sm:p-8 border border-sky/20 bubble-shadow-sm flex flex-col justify-between">
                    ...
                    {/* Application Deadline Box (pushed to bottom for perfect vertical alignment) */}
          ...
          {/* 4. Degree Programs Section — ONLY for CADT page, deleted/hidden for other pages */}
              ...
              {university.programs && university.programs.length > 0 && (
                <div>
                  <h3 className="font-display text-sm sm:text-base font-bold text-blue-ink mb-3">
                    Specialized Academic Highlights
                  </h3>
                ...
                {university.facultiesList.map((faculty, fIdx) => (
                  ...
                  >
                    <div>
                      ...
                      {/* List of Majors - Clean list without background */}
          ...
          {/* 6. Campus Highlights & Facilities (Decreased size, text on hover) */}
          ...
          <section className="w-full">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-6">
              <div>
                ...
                <p className="text-xs text-gray-soft font-medium mt-1">
                  Institutional grants and partner scholarships available for this university
                </p>
              </div>
              <Link
                href="/scholarships"
